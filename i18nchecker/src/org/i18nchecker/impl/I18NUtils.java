...
public class I18NUtils {
    ...
    public static List<String> createTranslationFilesHeader(String toolName, File rootDir, File importFromFile) throws IOException {
        List<String> header = new ArrayList<String>();
        header.add("# Do not edit! This file is generated by " + toolName + ".");
        String fName = importFromFile.getCanonicalPath();
        String rootDirFName = rootDir.getCanonicalPath();
        fName = fName.substring(rootDirFName.length()).replace(File.separator, "/");
